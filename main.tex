%% Use the 'ufgposter' class with the 'isoft' document-class option.
...
\sectionfont{\color{ufgdarkblue}} 
  
%% ::::::::::::::: Begin of the main editable info ::::::::::::::: %%. 
...
%% Background definition. Choose one of the options {1, 2 or 3} 
\setBackground{1}
