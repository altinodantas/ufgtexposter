...
\showcolumnseprule{0pt}

% Inform complete path to the logo files or leave empty one or both parameter. 
% Positions [T | M | B] 
\settinglogos[T]{images/ufg-logo}{images/department-logo}

% Choose one of the background options {1 | 2 | 3} 
\setbackground{3}

% Resize the title to keep it in two lines 
\resizetitle{64pt}{68pt}
